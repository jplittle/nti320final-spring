...
$servers->setValue('server','name','nti320 Example LDAP Server');
/* Examples:
   'ldap.example.com',
...
$servers->setValue('server','base',array('dc=nti320,dc=local'));
...
// $servers->setValue('login','bind_id','');
  $servers->setValue('login','bind_id','cn=ldapadm,dc=nti320,dc=local');
